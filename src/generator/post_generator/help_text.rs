...
pub fn handle_post_generate_help_text(
    ...
    match val {
        Value::String(_) | Value::Number(_) | Value::Bool(_) | Value::Array(_) => print_help_texts(
            val,
            template_dir,
            template_source_dir,
            project_dir,
...
fn print_help_texts(
    ...
    match val {
        Value::String(ref text) => print_single_help_text(
            text.as_str(),
            template_dir,
            template_source_dir,
            project_dir,
        ...
        Value::Number(ref num) => print_single_help_text(
        ...
        Value::Bool(ref b) => print_single_help_text(
            b.to_string().as_str(),
            template_dir,
            template_source_dir,
            project_dir,
...
fn print_single_help_text(
    ...
    let extra_data = gen_extra_template_data(template_dir, template_source_dir, project_dir);
